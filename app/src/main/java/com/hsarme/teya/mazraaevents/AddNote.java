...
public class AddNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i =getIntent();
        choosedate= (Date) i.getExtras().get("date");
    ...
    public void dataHandler() {
        ...
        reference.child(email).child("myNote").push().setValue(n).addOnCompleteListener(this, new OnCompleteListener<Void>() {
            @Override
